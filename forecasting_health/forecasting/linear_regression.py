...
savefig(f"forecasting_health/forecasting/images/{file_tag}_linear_regression_eval.png")
...
savefig(f"forecasting_health/forecasting/images/{file_tag}_linear_regression_forecast.png")
